    ...
    <>
      <div className="Navbar">
        <ul className="Navbar_block">
          ...
          <li className="Navbar_items">Settings</li>
      ...
      <div className="main2">
        ...
        >
          ...
          <br />
          <br />
          <Link to={`/search/${login.login.data}`}>
            <button
              className="btn"
              type="submit"
              onClick={(e) => {
        ...
        <p style={{ fontSize: "12px" }}>
          <a href="#covid19">
            Find ICMR authorized COVID-19 testing center near you
          </a>
        </p>
        <div>
          <ul className="languagelist">
            ...
            <li>
              <a href="#hindhi">हिन्दी</a>
            </li>
            <li>
              <a href="#jjjj">বাংলা</a>{" "}
            </li>
            <li>
              <a href="#telegu">తెలుగు</a>
            </li>
            <li>
              <a href="#marathi">मराठी</a>
            </li>
            <li>
              <a href="#tamizh">தமிழ்</a>
            </li>
            <li>
              <a href="#unknown">ગુજરાતી</a>
            </li>
            <li>
              <a href="#kannafa"> ಕನ್ನಡ</a>
            </li>
            <li>
              <a href="#malayalam">മലയാളം</a>
            </li>
            <li>
              <a href="#ud">ਪੰਜਾਬੀ</a>
            </li>
      ...
      <div className="footer">
        ...
        <div className="block2">
          <ul className="block2list0">
            <li>
              <ul className="block2list1">
                <li>About</li>
                <li>Advertising</li>
                <li>Business</li>
